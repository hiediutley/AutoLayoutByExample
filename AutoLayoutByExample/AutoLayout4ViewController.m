...
@interface AutoLayout4ViewController ()
{
  ...
  IBOutletCollection(NSLayoutConstraint) NSArray* _landscapeiPadHorizontalSpacingConstraints;
...
@implementation AutoLayout4ViewController
